...
const PaymentSuccess = () => {
    ...
    useEffect(() => {
        ...
        if (responseCode === "00" && !isOrderPlacedRef.current) {
            ...
            placeOrder();
        } else if (!isOrderPlacedRef.current) {
            setPaymentStatus({
                status: "failed",
    ...
    return (
        <div className={styles.containerPayment}>
            ...
            <Modal1
                ...
                ariaHideApp={false}
                className={styles1["modal-content"]}
                overlayClassName={styles1["react-modal-overlay"]}
            >
                ...
                <div className={styles1["rating"]}>
                    ...
                    {[1, 2, 3, 4, 5].map((star) => (
                        <FaStar
                            key={star}
                            className={star <= rating ? styles1["active-star"] : ""}
                ...
                <textarea
                    ...
                    className={styles1["feedback-textarea"]}
                />
