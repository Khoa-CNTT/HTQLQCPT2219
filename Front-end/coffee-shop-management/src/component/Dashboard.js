...
import {
    ...
    FaRegEdit,
    FaTools,
    FaMoneyBillWave, FaFileInvoiceDollar, FaGift, FaTags, FaCoffee, FaStore
} from "react-icons/fa";
...
const Dashboard = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subItems: [
                // { name: "Thêm Sản Phẩm", icon: <FaPlusCircle /> },
                { name: "Chỉnh Sửa Nguyên Liệu", icon: <FaTags  /> },
                // { name: "Xóa Sản Phẩm", icon: <FaTrash /> }
            ]
        }
    ];
                        ...
                        !selected[1] ? (
                            ...
                            <div className={styles.defaultContent}>
                                ...
                                <div className={styles.quickStats}>
                                    ...
                                    <div className={styles.statCard}>🧾 <span>{monthlyOrderCount}</span><p>Tổng hóa đơn tháng</p></div>
                                </div>
