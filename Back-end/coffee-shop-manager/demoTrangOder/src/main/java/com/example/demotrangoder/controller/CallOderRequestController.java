...
import com.example.demotrangoder.model.*;
import com.example.demotrangoder.repo.*;
import com.example.demotrangoder.service.CallOderRequestServiceImpl;
            ...
            if (productDTO.getToppings() != null) {
                for (Topping topping : productDTO.getToppings()) {
                    ...
                    for (ToppingIngredient toppingIngredient : toppingIngredients) {
                        ...
                        System.out.println("Tồn kho: " + currentStock + ", Cần dùng: " + totalRequired);
